...
class DDPGAgent:
    def __init__(self, action_size, state_size, lr_actor=1.0e-3, lr_critic=1.0e-3, tau=1.0e-2,
                 seed=10):
    ...
    def learn(self, experiences):
        ...
        clip_grad_norm_(self.critic_local.parameters(), self.clipgrad)
...
class MADDPG:
    def __init__(self, state_size, action_size, random_seed, num_agents):
        ...
        self.agents = [DDPGAgent(action_size, state_size) for _ in range(self.num_agents)]
    ...
    def step(self, states, actions, rewards, next_states, dones, timestamp):
        ...
        for t in zip(states, actions, rewards, next_states, dones):
            self.memory.add(*t)


        if len(self.memory) > BATCH_SIZE and timestamp % UPDATE_EVERY == 0:
